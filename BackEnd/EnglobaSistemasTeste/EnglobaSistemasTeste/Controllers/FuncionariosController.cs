...
namespace EnglobaSistemasTeste.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public FuncionariosController(EnglobaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Funcionarios != null ? 
                          ...
                          Problem("Entity set 'EnglobaContext.Funcionarios'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdFuncionario,Nome,Cpf,Rg,OrgaoEmissor,TituloEleitor,Cnh,Ativo,Gestor")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFuncionario,Nome,Cpf,Rg,OrgaoEmissor,TituloEleitor,Cnh,Ativo,Gestor")] Funcionario funcionario)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EnglobaContext.Funcionarios'  is null.");
            }
            var funcionario = await _context.Funcionarios.FindAsync(id);
            if (funcionario != null)
            {
